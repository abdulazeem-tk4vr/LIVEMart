...
<br/><br/>
If you'd like to start with Android development, you can check out this link. https://github.com/coder2hacker/Android-Development-RoadMap<br/>
<br/>
You should also check the courses on Udacity which are the visual equivalents.<br/>
